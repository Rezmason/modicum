...
const log = x => Math.log(Math.max(0, x));
 ...
 */
const colorTemperature2rgbUsingTH = (kelvin) => {
  ...
  return {r: Math.round(red) / 0xFF, g: Math.round(green) / 0xFF, b: Math.round(blue) / 0xFF};
}
 ...
 * original RGB to Kelvin data.
  ...
  * Output: json object of red, green and blue components of the Kelvin temperature
 */
const colorTemperature2rgb = (kelvin) => {
 ...
 */
const rgb2colorTemperature = (rgb) => {
